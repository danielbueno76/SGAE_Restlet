...
//			crearPersonaClientResource.put(f);
//			
...
//			crearGrupoClientResource.put(f);
...
//			annadirMiembroClientResource.put(f);
//			if(annadirMiembroClientResource.getStatus().equals(Status.SUCCESS_OK))
...
//			Form f = new Form();
//			f.add("DNI", "123456789A");
//			eliminarMiembroClientResource.put(f);
...
//			crearAlbumClientResource.post(f);
...
//			f.add("Duracion", "01-06-2001");
//			f.add("EJEMPLARESVENDIDOS", "10000");
//			crearPistaClientResource.post(f, MediaType.TEXT_PLAIN);
//			if(crearPistaClientResource.getStatus().equals(Status.SUCCESS_CREATED))
//				System.out.println("El album se ha creado correctamente.");
//			else
//				System.out.println("No se ha creado el album. Error: "+crearPistaClientResource.getStatus().getCode()+" "+crearPistaClientResource.getStatus().getDescription());
//		
//		} catch (ResourceException e) {
//			System.err.println("Error en la creación del grupo. Respuesta recibida: "+e.getStatus().getDescription());
//		}
...
//		System.out.println("\nListar todas las pistas:\n");
//		ClientResource listarPistasClientResource = new ClientResource ("http://localhost:8111/grupos/" +"Z0123456Z" +"/albumes/a1/pistas");
//		try{
...
//		//Borrar una pista
//		System.out.println("\nCrear una pista:\n");
//		ClientResource borrarPistaClientResource = new ClientResource ("http://localhost:8111/grupos/" + "Z0123456Z" +"/albumes/a1/pistas/p0");
//		try{
//			
//			borrarPistaClientResource.delete();
//			if(borrarPistaClientResource.getStatus().equals(Status.SUCCESS_OK))
